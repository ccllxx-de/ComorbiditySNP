...
# 1. Load data
file_path = "/content/drive/MyDrive/RR2topandrandom_neg_means_df.csv"
...
top_means = df[df['Group'] == 'Top negative SNPs RR2']['Mean_negative_Effect'].abs()
random_means = df[df['Group'] == 'Random negative SNPs RR2']['Mean_negative_Effect'].abs()
...
plt.tight_layout()
plt.savefig("/content/drive/MyDrive/RR2neg_snps_absolute_effect_histogram.png")
plt.show()