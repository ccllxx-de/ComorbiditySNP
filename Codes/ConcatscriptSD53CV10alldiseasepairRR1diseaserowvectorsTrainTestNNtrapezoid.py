...
sys.stdout = open(os.path.join(output_dir, "Concat_model_resultsCV10alldiseasepairRR1diseaserowvectorsPCA100TrainTestNNtrapezoid.txt"), "w")
...
cv_fold_df.to_csv(os.path.join(output_dir, "Concat_CV10Fold_Metrics_PerModelSDVarCV10RR1diseaserowvectorsalldiseasepairPCA100TrainTestNNtrapezoid.csv"), index=False)
...
# Save metrics to CSV
pd.DataFrame(all_metrics).to_csv(os.path.join(output_dir, "Concat_all_model_metricsCV10RR1diseaserowvectorsalldiseasepairPCA100TrainTestNNtrapezoid.csv"), index=False)
...
plt.title("Precision-Recall Curve PCA100 RR1 diseaserowvectors CV10 alldiseasepair NNtrapezoid")
plt.legend()
plt.grid()
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "pr_curveRR1diseaserowvectorsCV10alldiseasepairTrainTestConcatNNtrapezoid.png"))
