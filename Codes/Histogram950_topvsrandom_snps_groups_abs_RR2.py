...
# -----------------------------
file_name = "/content/drive/MyDrive/950_topvsrandom_snps_groups_abs_RR2.csv"
...
plt.hist(top_capped, bins=bins, histtype='step', color='#d62728',
         label=f'Target/Top SNPs (n=950)', linewidth=2.8, zorder=3)

# Random SNPs - red/orange
plt.hist(random_capped, bins=bins, histtype='step', color='#1f77b4',
         label=f'Random SNPs (n=950)', linewidth=2.8, zorder=3)
...
plt.title("Distribution of Mean Absolute Effect per SNP\n"
          "950 Top vs 950 Random SNPs", fontsize=15, pad=20)
...
# 8. Save the plot
# -----------------------------
output_plot_file = "/content/drive/MyDrive/RR2_mean_abs_effect_histogram_top_vs_random_cap20.png"
