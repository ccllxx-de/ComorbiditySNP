...
# 1. Load data
file_path = "/content/drive/MyDrive/RR2topandrandom_pos_means_df.csv"
...
top_means = df[df['Group'] == 'Top Positive SNPs RR2']['Mean_Positive_Effect'].abs()
random_means = df[df['Group'] == 'Random Positive SNPs RR2']['Mean_Positive_Effect'].abs()
...
plt.tight_layout()
plt.savefig("/content/drive/MyDrive/RR2pos_snps_absolute_effect_histogram.png")
plt.show()