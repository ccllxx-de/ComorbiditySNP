...
def run_w_matrix_performance(snp_path, labels_path, phecode_list_path):
    ...
    # Save files
    summary.to_csv("/content/drive/MyDrive/w_matrix_performance_summaryRR1.csv", index=False)
    return summary

if __name__ == "__main__":
    run_w_matrix_performance("/content/drive/MyDrive/DiseaseInteractiveNetwork/data_bioinfo/disease_snp.npz",
                             "/content/drive/MyDrive/disease_pairs_with_labels.csv", "/content/drive/MyDrive/DiseaseInteractiveNetwork/data_bioinfo/phecode_list.csv")