...
sys.stdout = open(os.path.join(output_dir, "model_results_SNP_PCA_Importance.txt"), "w")
...
cv_fold_df.to_csv(os.path.join(output_dir, "Metrics_SNP_PCA_Detailed.csv"), index=False)
...
metrics_df.to_csv(os.path.join(output_dir, "model_metrics_SNP_PCA_Final.csv"), index=False)
